...
export class ListEventsHandler extends BaseToolHandler {
  async runTool(
    ...
    console.log(`fetching events from calendars: ${calendarIds}\n`);
  ...
  private async fetchEvents(
    ...
    console.log("using batch request for multiple calendars\n");
    let result = this.fetchMultipleCalendarEvents(client, calendarIds, options);
    console.log("fetched events using batch request\n");
    return result;
  }
